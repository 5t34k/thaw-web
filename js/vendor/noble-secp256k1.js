...
// --- vendored for offline classic-script use (thaw-web) ---
// Original ESM export replaced with a global namespace assignment so this file
// loads via <script src> from file:// without a server or import maps.
window.nobleSecp256k1 = {
  getPublicKey, sign, signAsync, verify, CURVE,
